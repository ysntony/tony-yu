...
df["Views"] = df["Views"].apply('{:,}'.format)
df["Likes"] = df["Likes"].apply('{:,}'.format)
df["Comments"] = df["Comments"].apply('{:,}'.format)
df["Shares"] = df["Shares"].apply('{:,}'.format)
